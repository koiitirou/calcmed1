              ...
              child: Form(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      MySelect1func1(
                          _sc1, '性別', '男性', '女性', '', '', _calculateCCR),

                      FormTmp1(ageController, '年齢', '数値を入力して下さい', '00', '歳',
                          _calculateCCR),
                      FormTmp1(weiController, '体重', '数値を入力して下さい', '00.0', 'kg',
                          _calculateCCR),
                      FormTmp1(creController, '血清クレアチニン値', '数値を入力して下さい', '0.00',
                          'mg/dL', _calculateCCR),

                      InpPadding('結果'),
                      ResContainer2(
                          'Ccr, クレアチニンクリアランス', _ccrString, '  mL/min'),
                      ResContainer2(
                          'eGFR, 推算糸球体濾過量', _egfString, '  mL/min/1.73㎡'),
